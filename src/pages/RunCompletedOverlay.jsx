    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center backdrop-blur-md z-40 p-4 animate-fade-in">
      <div className="relative flex flex-col items-center scale-[0.8] lg:scale-[1] will-change-transform">
        ...
        <div className="w-full md:max-w-xl flex flex-col drop-shadow-[0_12px_24px_rgba(0,0,0,0.6)] image-render-pixelated relative">
          <img src={assetPath('assets/scoreboard-top.png')} alt="" className="w-full object-contain select-none pointer-events-none" />
          <div
            className="w-full bg-repeat-y bg-[length:100%_auto] px-6 py-1 flex flex-col items-center text-center"
            style={{ backgroundImage: `url(${assetPath('assets/scoreboard-center.png')})` }}
          >
            ...
            <div className="grid grid-cols-3 gap-2.5 sm:gap-4 mb-4 w-full max-w-[480px] mx-auto">
              ...
              <div className="flex flex-col items-center select-none w-full">
                ...
                <div className="w-[92%] relative flex flex-col items-center justify-between z-20 border-2 border-[#b68263] rounded-t-none rounded-md p-2 bg-[#f9e7c3] shadow-[0_4px_8px_rgba(0,0,0,0.25)]">
                  ...
                  <div className="my-1.5 p-1.5 sm:p-2 rounded-lg bg-[#cfa174] border border-[#b68263]/30 flex items-center justify-center shadow-inner">
                    <img src={assetPath('assets/status-star.png')} alt="Stars" className="w-[20px] h-[20px] lg:w-[32px] lg:h-[32px] object-contain image-render-pixelated select-none pointer-events-none" />
                  </div>
              ...
              <div className="flex flex-col items-center select-none w-full">
                ...
                <div className="w-[92%] relative flex flex-col items-center justify-between z-20 border-2 border-[#b68263] rounded-t-none rounded-md p-2 bg-[#f9e7c3] shadow-[0_4px_8px_rgba(0,0,0,0.25)]">
                  <div className="w-full absolute top-0 left-0 h-[5px] bg-[#f0d2a6]"></div>
                  <div className="my-1.5 p-1.5 sm:p-2 rounded-lg bg-[#cfa174] border border-[#b68263]/30 flex items-center justify-center shadow-inner">
                    <img src={assetPath('assets/status-run.png')} alt="Steps" className="w-[20px] h-[20px] lg:w-[32px] lg:h-[32px] object-contain image-render-pixelated select-none pointer-events-none" />
                  </div>
              ...
              <div className="flex flex-col items-center select-none w-full">
                ...
                <div className="w-[92%] relative flex flex-col items-center justify-between z-20 border-2 border-[#b68263] rounded-t-none rounded-md p-2 bg-[#f9e7c3] shadow-[0_4px_8px_rgba(0,0,0,0.25)]">
                  <div className="w-full absolute top-0 left-0 h-[5px] bg-[#f0d2a6]"></div>
                  <div className="my-1.5 p-1.5 sm:p-2 rounded-lg bg-[#cfa174] border border-[#b68263]/30 flex items-center justify-center shadow-inner">
                    <img src={assetPath('assets/status-coins.png')} alt="Coins" className="w-[20px] h-[20px] lg:w-[32px] lg:h-[32px] object-contain image-render-pixelated select-none pointer-events-none" />
                  </div>
                  <p className="text-sm sm:text-xl font-black text-slate-900 font-sans tracking-tight">
                    {coins}
                  </p>
            ...
            <div className="flex items-center justify-center gap-2 sm:gap-3 text-amber-950 font-black tracking-wide text-xs sm:text-sm -mb-[20px] uppercase drop-shadow-[0_1px_0_rgba(255,255,255,0.4)]">
              <img src={assetPath('assets/trophy.png')} alt="Trophy" className="h-6 sm:h-8 object-contain select-none pointer-events-none image-render-pixelated" />
              <span>Your rank:</span>
              {(() => {
                if (!rank) {
                ...
                if (rank === 1) return <img src={assetPath('assets/rank-gold.png')} alt="Gold" className="h-8 sm:h-10 object-contain select-none pointer-events-none image-render-pixelated" />;
                if (rank === 2) return <img src={assetPath('assets/rank-silver.png')} alt="Silver" className="h-8 sm:h-10 object-contain select-none pointer-events-none image-render-pixelated" />;
                if (rank === 3) return <img src={assetPath('assets/rank-bronze.png')} alt="Bronze" className="h-8 sm:h-10 object-contain select-none pointer-events-none image-render-pixelated" />;
          ...
          <img src={assetPath('assets/scoreboard-bot.png')} alt="" className="w-full object-contain select-none pointer-events-none" />
        </div>
